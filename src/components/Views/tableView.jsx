...
//   const handleEditStart = (rowIndex) => {
//     const rowData = filteredData.slice((currentPage - 1) * pageSize, currentPage * pageSize)[rowIndex];
//     setEditingRow(rowIndex);
//     setEditedRowData({ ...rowData });
//     if (onEditStart) {
...
//   const handleSave = () => {
//     if (editingRow !== null) {
//       const updatedRow = { ...filteredData[(currentPage - 1) * pageSize + editingRow], ...editedRowData };
//       setTableData((prev) =>
//         prev.map((item, idx) => (idx === (currentPage - 1) * pageSize + editingRow ? updatedRow : item))
//       );
//       setShowConfirmation(true);
//       if (onEditSave) onEditSave(updatedRow);
//     }
//     setEditingRow(null);
//     setEditedRowData({});
//   };
...
//   };
//   const handleDrop = (targetCol) => {
//     // Temporarily disable drag-and-drop to isolate the issue
//     setDraggingColumn(null);
//     setDropTarget(null);
//   };
