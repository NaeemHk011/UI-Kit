      ...
      {scrollEnabled && (
        <>
          <div className="absolute top-1 right-1 bg-white rounded-full p-1 shadow">
            <span className="block w-3 h-3 border-t-2 border-r-2 border-gray-600 rotate-45"></span>
          </div>
          <div className="absolute bottom-1 right-1 bg-white rounded-full p-1 shadow">
            <span className="block w-3 h-3 border-b-2 border-r-2 border-gray-600 -rotate-45"></span>
          </div>
        </>
      )}
